...
const ButlerMark = ({ size = 16 }: { size?: number }) => (
  ...
  return (
    <footer className="pb-footer">
      <div className="pb-footer-inner">
        ...
        <div className="pb-footer-copy">
          <p className="pb-footer-note">
            mypointsbutler.com · Forecasts are estimates, not guarantees. Always confirm award space
            before transferring points.
          </p>
          <nav className="pb-footer-links" aria-label="Legal">
